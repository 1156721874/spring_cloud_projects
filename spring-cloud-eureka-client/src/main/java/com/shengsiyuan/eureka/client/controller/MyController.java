package com.shengsiyuan.eureka.client.controller;


import com.shengsiyuan.eureka.client.domain.Parent;
import com.shengsiyuan.eureka.client.domain.Student;
...
//        }
        ...
        String result = "welcome: " + this.name + ", your address is " + this.address;
    ...
    public Student getStudentByPostRequest(@RequestBody Parent parent, HttpServletRequest request) {
        System.out.println("authKey: " + request.getHeader("authKey"));
